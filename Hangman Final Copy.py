...
The letter {} isn't in the word, you now have {} attempts left""".format(players_guess, players_attempts))
                ...
                if replay == 4:
                    print("You have played your 3 games. Have a nice day. ") #Will output this when user has players 3 games 
